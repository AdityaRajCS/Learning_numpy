...
My notes and practice while learning **NumPy**, from the basics to more advanced concepts.

This repository contains both:
- **Practice notebooks** where I experiment with NumPy.
- **Notes notebooks** where I summarize important concepts for revision.
...
7. [Operations Notes](7_operationsNotes.ipynb)
8. [Reshaping Arrays](8_reshapingArrays.ipynb)
   - [Reshaping Notes 1](8.1_reshaping.ipynb)
   - [Reshaping Notes 2](8.2_reshaping.ipynb)
   - [Reshaping Notes 3](8.3_reshaping.ipynb)
...
12. [Broadcasting](12_broadcasting.ipynb)
